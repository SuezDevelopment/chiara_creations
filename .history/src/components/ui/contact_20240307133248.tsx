const Contact = () => {
    return (
      <section id="contact" className="relative py-40 md:py-[150px]">
            ...
            <div className="w-full px-4 lg:w-7/12 xl:w-8/12">
              <div className="ud-contact-content-wrapper">
                <div className="ud-contact-title mb-12 lg:mb-[150px]">
                  ...
                  <h2 className="max-w-[360px] text-[35px] font-bold leading-[1.14] text-dark">
              ...
              >
                ...
                <form>
                  ...
                  <div className="mb-0">
                    <button
                      type="submit"
                      className="inline-flex items-center justify-center rounded-md bg-primary px-10 py-3 text-base font-extrabold transition duration-300 ease-in-out hover:bg-primary/90"
                    >
                      Send
                    </button>
                  </div>
